          ...
          <div class="col-md-12">
            <div class="form-block mx-auto">
              <div class="text-center mb-5">
                <h3 class="text-uppercase">Register Danou Toba<strong></strong></h3>
              </div>
              <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group last mb-3">
                  ...
                  <input type="password" class="form-control"  placeholder="Masukan Password" name="password_confirmation"  id="password-confirm">
            </div>
                @error('password')
                    <div class="invalid-feedback" style="display: block; color: red;">
                        {{ $message }}
